...
insert into Product ([name], [SKU], [description], [price], [stock], [material], [gender], [shape], [color], [image], [gallery], [eye_width], [eye_lenth], [InventoryDate], [entryPrice], [category_id]) values
